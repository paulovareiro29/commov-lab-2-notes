package ipvc.paulovareiro.notes.fragments.update
...
import ipvc.paulovareiro.notes.R
import ipvc.paulovareiro.notes.data.entities.Note
import ipvc.paulovareiro.notes.data.vm.NoteViewModel
...
class UpdateFragment : Fragment() {
    ...
    private  fun updateNote(){
        ...
        if(noteText.isEmpty()) {
            Toast.makeText(context , "Não pode uma nota vazia!", Toast.LENGTH_LONG).show()
        }
        else {
